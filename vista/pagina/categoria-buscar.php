...
<div class="container">
	<ul class="full-box list-unstyled page-tabs">
		...
		<li>
			<a href="<?php echo urlServidor; ?>categoria-buscar/" class="active"><i class="fa-solid fa-magnifying-glass fa-fw"></i> &nbsp; Buscar categoria</a>
		</li>
	</ul>
</div>
<div class="container">
	<div class="px-3">
		<div class="card mb-4">
						...
						<div class="row justify-content-center">
							<div class="col-lg-6 col-md-6 col-10">
								<div class="input-group mb-3">
									<input type="text" name="buscar_palabra" class="form-control form-control-sm text-center" placeholder="¿Qué categoria estás buscando?">
					...
					<div class="container text-center">
						<div class="row">
							<div class="col-lg-12 col-md-12 col-12">
								<div class="m-0">
									<p>Resultados de la búsqueda <strong><?php echo $_SESSION['busqueda_categoria']; ?></strong></p>
								</div>
							</div>
							<div class="col-lg-12 col-md-12 col-12">
								<div class="mb-3">
			...
			echo $categoria_controlador->listar_categorias_controlador($pagina[1], 5, $pagina[0], $_SESSION['busqueda_categoria']);
			}
			?>
			</div>
		</div>
